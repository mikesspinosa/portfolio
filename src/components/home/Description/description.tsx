      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
        ...
        <div className="relative md:mt-4">
            ...
            <div data-scroll-speed={0.1} className="relative mt-8 flex w-full justify-center">
              <Link href={'/about'}>
                <RoundedButton className="flex h-[120px] w-[120px] sm:h-[150px] sm:w-[150px] md:h-[180px] md:w-[180px] cursor-pointer items-center justify-center rounded-full bg-destructive text-white text-xl">
                  Sobre mí
                </RoundedButton>
              </Link>
            </div>
